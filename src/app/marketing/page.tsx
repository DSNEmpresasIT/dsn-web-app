  ...
  return (
    <>
      <section className="relative flex md:h-screen  py-44 items-center bg-cover bg-center self-center">
        <div
          className="absolute inset-0 h-full w-full  jarallax"
          data-jarallax
          data-speed="0.8"
          style={{ background: `url('/images/photography/first.jpg') bottom` }}
        ></div>
        <div
          className="absolute inset-0 h-full w-full md:block hidden jarallax"
          data-jarallax
          data-speed="0.5"
          style={{
            background: `url('/images/photography/hero-text-lg.png') center`,
          }}
        ></div>
        <div
          className="absolute inset-0 h-full w-full block md:hidden jarallax"
          data-jarallax
          data-speed="0.5"
          style={{
            background: `url('/images/photography/hero-text-sm.png') center`,
          }}
        ></div>
        <div
          className="absolute inset-0 h-full w-full jarallax"
          data-jarallax
          data-speed="1.1"
          style={{ background: `url('/images/photography/last.png') bottom` }}
        ></div>
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              As a Freelance Designer & Developer, I am here to make you stand
              out in the digital world and my passion for design and your vision
              will ensure a great end result.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            <div className="relative overflow-hidden h-fit">
              ...
              <div className="absolute text-center p-6 bottom-0 start-0 end-0">
                ...
                >
                  Jack Jeffrey <FiArrowUpRight className="ms-2" />
                </Link>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden h-fit lg:mt-16">
              ...
              <div className="absolute text-center p-6 bottom-0 start-0 end-0">
                <Link
                  ...
                  className="font-semibold text-lg flex items-center"
                >
                  Portfolio <FiArrowUpRight className="ms-2" />
                </Link>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden h-fit">
              ...
              <div className="absolute text-center p-6 bottom-0 start-0 end-0">
                <Link
                  ...
                  className="font-semibold text-lg flex items-center"
                >
                  Contact <FiArrowUpRight className="ms-2" />
                </Link>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden h-fit lg:mt-16">
              ...
              <div className="absolute text-center p-6 bottom-0 start-0 end-0">
                <Link
                  ...
                  className="font-semibold text-lg flex items-center"
                >
                  About Me <FiArrowUpRight className="ms-2" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section
        className="relative md:py-56 py-44 bg-cover jarallax bg-fixed"
        id="aboutme"
        style={{
          backgroundImage: "url('/images/photography/photographer.jpg')",
        }}
      >
        <div className="absolute inset-0 h-full w-full bg-gradient-to-t to-transparent via-white/80 dark:via-slate-900/80 from-white dark:from-slate-900"></div>
          ...
          <div className="flex justify-center">
            <div className="lg:max-w-768 w-full text-center">
              <p>
                ...
                to have originated in the 16th century. Lorem Ipsum is composed
                in a pseudo-Latin language which more or less corresponds to
                proper Latin. It contains a series of real Latin words.
              </p>
              <p className="text-slate-400 mt-6">
                This ancient dummy text is also incomprehensible, but it
                imitates the rhythm of most European languages in Latin script.
                The advantage of its Latin origin and the relative
                meaninglessness of Lorum Ipsum is that the text does not attract
                attention to itself or distract the viewers attention from the
                layout.
              </p>
              <p className="text-slate-400 mt-6">
                Moreover, in Latin only words at the beginning of sentences are
                capitalized; this means that Lorem Ipsum cannot accurately
                represent, for example, German, in which all nouns are
                capitalized. Thus, Lorem Ipsum has only limited suitability as a
                visual filler for German texts.
              </p>
              <p className="text-slate-400 mt-6">
                If the fill text is intended to illustrate the characteristics
                of different typefaces, it sometimes makes sense to select texts
                containing the various letters and symbols specific to the
                output language.
              </p>
              <p className="text-slate-400 mt-6">
                    ...
                    <div className="group relative block overflow-hidden rounded-md transition-all duration-500">
                      ...
                      <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center opacity-0 group-hover:opacity-100 duration-500">
                        <Link
                          ...
                          className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white lightbox"
                        >
